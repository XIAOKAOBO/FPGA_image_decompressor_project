...
mem save -o simulation_RAM0.mem -f mti -data decimal -addr decimal -wordsperline 1 /tb_project_v2/uut/dual_port_RAM_inst0/altsyncram_component/mem_data
mem save -o simulation_RAM1.mem -f mti -data decimal -addr decimal -wordsperline 1 /tb_project_v2/uut/dual_port_RAM_inst1/altsyncram_component/mem_data
