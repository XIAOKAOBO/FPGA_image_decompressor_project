...
//`define OUTPUT_FILE_NAME "mo_tb.ppm"

// file for comparison
// to test milestone 2 independently, use the .sram_d1 file to check the output
`define VERIFICATION_FILE_NAME "motorcycle.sram_d2"
...
begin
	...
	for (i=76800; i<230400; i=i+1) begin
...
initial begin
	...
	wait (uut.top_state == 0);uut.start_flag=0;	//this assumes we go back to S_IDLE when we are done
...
always @ (posedge Clock_50) begin
	if (uut.SRAM_we_n == 1'b0) begin	//signal names within project (instantiated as uut) should match here, assuming names from experiment4a
		...
		if (uut.SRAM_address < 76800||uut.SRAM_address>230399) begin
